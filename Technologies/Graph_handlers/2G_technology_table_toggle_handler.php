...
<!-- -----------------2G NETWORK SAR VALUES GRAPH GENERATOR--------------------- -->
    ...
    function reloadGraph(){
      ...
      <?php
          include("../includes/db_connector_string.php");
           ...
           $num_of_rows = "SELECT count(*) FROM 2G_technology";
           $result = mysqli_query($connect, $query);
           $technology = "2G Network";
                // creates connection and fetch from db table[2G_technology]
      ?>
