...
<!-- -----------------4G NETWORK SAR VALUES GRAPH GENERATOR--------------------- -->
    ...
    function reloadGraph(){
      ...
      <?php
          include("../includes/db_connector_string.php");
           ...
           $query = "SELECT * FROM 4G_technology";
           $num_of_rows = "SELECT count(*) FROM 4G_technology";
           $result = mysqli_query($connect, $query);
           $technology = "4G Network";
                // creates connection and fetch from db table[4G_technology]
      ?>
