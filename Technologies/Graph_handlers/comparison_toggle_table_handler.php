    ...
    function reloadGraph(){
      ...
      <?php
          include("../includes/db_connector_string.php");
           ...
           $query = "SELECT * FROM Male_adult";
           $num_of_rows = "SELECT count(*) FROM Male_adult";
           $result = mysqli_query($connect, $query);
           $technology = "Adult";
                // creates connection and fetch from the 1st db table[3G_technology]
      ?>
          ...
          data:[
            ...
            },
            {
                <?php
                  include("../../includes/db_connector_string.php");
                      //extends db connection file
                   $query2 = "SELECT * FROM Female_adult";
                   $num_of_rows2 = "SELECT count(*) FROM Female_adult";
                   $result2 = mysqli_query($connect2, $query2);
                        // creates connection and fetch from the 2nd db
                ?>
          label: 'Female Adult SAR',
          data:[
