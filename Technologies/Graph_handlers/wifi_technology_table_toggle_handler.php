...
<!-- -----------------WiFi NETWORK SAR VALUES GRAPH GENERATOR--------------------- -->
    ...
    function reloadGraph(){
      ...
      <?php
          include("../includes/db_connector_string.php");
           ...
           $query = "SELECT * FROM wifi_technology";
           $num_of_rows = "SELECT count(*) FROM wifi_technology";
           $result = mysqli_query($connect, $query);
           $technology = "WiFi Network";
                // creates connection and fetch from db table[WiFi_technology]
      ?>
