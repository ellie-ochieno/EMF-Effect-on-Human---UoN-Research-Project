...
?>
    ...
    <style type="text/css">
      a.calc_tools-active{
        ...
        #dielectric_properties_result_sctn,
        #tissue_thickness_result_sctn,
        #sar_advncd_result_sctn,
        #sar_basic_result_sctn,
        #fspl_result_sctn,
        #skin_dpth_result_sctn,
          ...
          font-weight: bold !important;
            ...
            <div class="calc-tools-links">
              <ul>
                ...
                <li><a href="#head_model">Tissue Thickness Calculator</a></li>
            ...
            <div class="content-tools">
                ...
                <div class="calc-tool-section">
                  <form class="calc-tool-section" id="skin_dpth_form">
                    <br><p style="color: #405580;">Calculate material skin depth<br><br>
                      ...
                      <input class="fr-inputs sar_rel_permeability_val" id="sar_rel_permeability_val" type="double" name="sar_rel_permeability" title="By default can be set to unity" required><br><br><br>
                      ...
                      <div class="skin_dpth_result_sctn" id="skin_dpth_result_sctn">
                        <label class="rf-lalbels" style="color: #537895">Skin Depth Result:</label><br>
                        <input class="fr-inputs result_input_field" id="skin_dpth_result_val" type="double" name="skin_depth_result_field" readonly>&nbsp;[m]<br>
                      </div>
                    </p>
                  </form>
                </div>
              ...
              <div class="fspl">
                ...
                <div class="calc-tool-section">
                  ...
                  <br><p style="color: #405580;">Calculate signal strength loss in free space.<br><br>
                      ...
                      <div class="fspl_result_sctn" id="fspl_result_sctn">
                        <label class="rf-lalbels" style="color: #537895">FSPL Result:</label><br>
                        <input class="fr-inputs result_input_field" id="fspl_result_val" type="double" name="fspl_result_field" readonly>&nbsp;[dB]<br>
                      </div>
                    </p>
                  </form>
                </div>
              ...
              <div class="head_model">
                <div class="dfn-section">
                  ...
                  <a name="head_model"></a>
                  <p><span class="special-term"><i></i></span>In order to assess human exposure to RF electromagnetic fields, it is required to
                ...
                <div class="calc-tool-section">
                  <form class="calc-tool-section" id="head_siz_model_form">
                    <br><p style="color: #405580;">Calculate tissue thickness<br><br>
                      ...
                      <div class="tissue_thickness_result_sctn" id="tissue_thickness_result_sctn">
                          <label class="rf-lalbels" style="color: #537895">Tissue thickness result</label><br>
                          <label class="rf-lalbels" style="margin-right:2%;">Skin:&nbsp;&nbsp;</label>
                          <input class="fr-inputs result_input_field" id="head_siz_model_skin_thcknss_result_val" type="double" name="head_siz_model_result_field" readonly>&nbsp;[m]<br>
                          <label class="rf-lalbels" style="margin-right:2%;">Fat:&nbsp;&nbsp;&nbsp;&nbsp;</label>
                          <input class="fr-inputs result_input_field" id="head_siz_model_fat_thcknss_result_val" type="double" name="head_siz_model_result_field" readonly>&nbsp;[m]<br>
                          <label class="rf-lalbels" style="margin-right:1%;">Bone:&nbsp;</label>
                          <input class="fr-inputs result_input_field" id="head_siz_model_bone_thcknss_result_val" type="double" name="head_siz_model_result_field" readonly>&nbsp;[m]<br>
                          <label class="rf-lalbels" style="margin-right:2%;">Brain:</label>
                          <input class="fr-inputs result_input_field" id="head_siz_model_brain_thcknss_result_val" type="double" name="head_siz_model_result_field" readonly>&nbsp;[m]<br>
                      </div>
                    </p>
                  </form>
                </div>
                ...
                <div class="calc-tool-section">
                  <form class="calc-tool-section" id="dielectric_properties_form">
                    <br><p style="color: #405580;">Determine Tissues Dielectric Properties<br><br>
                      ...
                      <div class="dielectric_properties_result_sctn" id="dielectric_properties_result_sctn">
                          ...
                          <input class="fr-inputs result_input_field result_input_field_dielec_prop" id="dielec_prop_skin_condctvty_val" type="double" name="dielec_prop_skin_condctvty_field"> readonly&nbsp;[S/m]<br>
                          <label class="rf-lalbels" style="margin-right:2%;"><span class="special-term-abbriv"><i>&epsilon;<sub>r</sub>: </i></span>&nbsp;&nbsp;</label>
                          <input class="fr-inputs result_input_field result_input_field_dielec_prop" id="dielec_prop_skin_rel_permitvtty_val" type="double" name="dielec_prop_skin_rel_permitvtty_field" readonly>&nbsp;<br>
                          <label class="rf-lalbels" style="margin-right:1%;"><span class="special-term-abbriv"><i>m<sub>d</sub>: </i></span>&nbsp;</label>
                          <input class="fr-inputs result_input_field result_input_field_dielec_prop" id="dielec_prop_skin_density_val" type="double" name="dielec_prop_skin_density_field" style="margin-right: 2" readonly>&nbsp;[Kg/m<sup>3</sup>]<br><br>

                          <label class="rf-lalbels">2. Fat tissue properties</label><br>
                          <label class="rf-lalbels" style="margin-right:2%;"><span class="special-term-abbriv"><i>&sigma;: </i></span>&nbsp;&nbsp;&nbsp;</label>
                          <input class="fr-inputs result_input_field result_input_field_dielec_prop" id="dielec_prop_fat_condctvty_val" type="double" name="dielec_prop_fat_condctvty_field" readonly>&nbsp;[S/m]<br>
                          <label class="rf-lalbels" style="margin-right:2%;"><span class="special-term-abbriv"><i>&epsilon;<sub>r</sub>: </i></span>&nbsp;&nbsp;</label>
                          <input class="fr-inputs result_input_field result_input_field_dielec_prop" id="dielec_prop_fat_rel_permitvtty_val" type="double" name="dielec_prop_fat_rel_permitvtty_field" readonly>&nbsp;<br>
                          <label class="rf-lalbels" style="margin-right:1%;"><span class="special-term-abbriv"><i>m<sub>d</sub>: </i></span>&nbsp;</label>
                          <input class="fr-inputs result_input_field result_input_field_dielec_prop" id="dielec_prop_fat_density_val" type="double" name="dielec_prop_fat_density_field" style="margin-right: 2" readonly>&nbsp;[Kg/m<sup>3</sup>]<br><br>

                          <label class="rf-lalbels">3. Bone tissue properties</label><br>
                          <label class="rf-lalbels" style="margin-right:2%;"><span class="special-term-abbriv"><i>&sigma;: </i></span>&nbsp;&nbsp;&nbsp;</label>
                          <input class="fr-inputs result_input_field result_input_field_dielec_prop" id="dielec_prop_bone_condctvty_val" type="double" name="dielec_prop_bone_condctvty_field" readonly>&nbsp;[S/m]<br>
                          <label class="rf-lalbels" style="margin-right:2%;"><span class="special-term-abbriv"><i>&epsilon;<sub>r</sub>: </i></span>&nbsp;&nbsp;</label>
                          <input class="fr-inputs result_input_field result_input_field_dielec_prop" id="dielec_prop_bone_rel_permitvtty_val" type="double" name="dielec_prop_bone_rel_permitvtty_field" readonly>&nbsp;<br>
                          <label class="rf-lalbels" style="margin-right:1%;"><span class="special-term-abbriv"><i>m<sub>d</sub>: </i></span>&nbsp;</label>
                          <input class="fr-inputs result_input_field result_input_field_dielec_prop" id="dielec_prop_bone_density_val" type="double" name="dielec_prop_bone_density_field" style="margin-right: 2" readonly>&nbsp;[Kg/m<sup>3</sup>]<br><br>

                          <label class="rf-lalbels">4. Brain tissue properties</label><br>
                          <label class="rf-lalbels" style="margin-right:2%;"><span class="special-term-abbriv"><i>&sigma;: </i></span>&nbsp;&nbsp;&nbsp;</label>
                          <input class="fr-inputs result_input_field result_input_field_dielec_prop" id="dielec_prop_brain_condctvty_val" type="double" name="dielec_prop_brain_condctvty_field" readonly>&nbsp;[S/m]<br>
                          <label class="rf-lalbels" style="margin-right:2%;"><span class="special-term-abbriv"><i>&epsilon;<sub>r</sub>: </i></span>&nbsp;&nbsp;</label>
                          <input class="fr-inputs result_input_field result_input_field_dielec_prop" id="dielec_prop_brain_rel_permitvtty_val" type="double" name="dielec_prop_brain_rel_permitvtty_field" readonly>&nbsp;<br>
                          <label class="rf-lalbels" style="margin-right:1%;"><span class="special-term-abbriv"><i>m<sub>d</sub>: </i></span>&nbsp;</label>
                          <input class="fr-inputs result_input_field result_input_field_dielec_prop" id="dielec_prop_brain_density_val" type="double" name="dielec_prop_brain_density_field" style="margin-right: 2" readonly>&nbsp;[Kg/m<sup>3</sup>]<br>
                      </div>
                    </p>
                  </form>
                </div>
                    ...
                    <div class="calc-tool-section">
                      <form class="calc-tool-section" id="sar_form">
                          <br><p style="color: #405580;">Calculate specific absorption rate for the material.<br><br>
                            ...
                            <div class="sar_basic_result_sctn" id="sar_basic_result_sctn">
                              <label class="rf-lalbels" style="color: #537895">SAR Result</label><br>
                  ...
                  <div class="calc-tool-section">
                    <form class="calc-tool-section" id="sar_advanced_form">
                        <br><p style="color: #405580;">Calculate specific absorption rate for the material.<br><br>
                          ...
                          <div class="sar_advncd_result_sctn" id="sar_advncd_result_sctn">
                              <label class="rf-lalbels" style="color: #537895">Skin depth</label><br>
                              <input class="fr-inputs result_input_field" id="sar_advncd_skin_dpth_result_val" type="double" name="sar_advncd_result_field" readonly>&nbsp;[m]<br><br>
                              <label class="rf-lalbels" style="color: #537895">Impedance</label><br>
                              <input class="fr-inputs result_input_field" id="sar_advncd_impedance_result_val" type="double" name="sar_advncd_result_field" readonly>&nbsp;[&Omega;]<br><br>
                              <label class="rf-lalbels" style="color: #537895">Power density[<span class="special-term-abbriv">S</span>]</label><br>
                              <input class="fr-inputs result_input_field" id="sar_advncd_pwr_dnsty_result_val" type="double" name="sar_advncd_result_field" readonly>&nbsp;[W/m<sup>3</sup>]<br><br>
                              <label class="rf-lalbels" style="color: #537895">Electric field intensity[<span class="special-term-abbriv">E<sup>2</sup></span>]</label><br>
                              <input class="fr-inputs result_input_field" id="sar_advncd_e_field_result_val" type="double" name="sar_advncd_result_field" readonly>&nbsp;[V/m]<br><br>
                              <label class="rf-lalbels" style="color: #537895">SAR Result:</label><br>
                              <input class="fr-inputs result_input_field" id="sar_advncd_result_val" type="double" name="sar_advncd_result_field" readonly>&nbsp;[W/Kg]<br>
                          </div>
                        </p>
                    </form>
                  </div>
            ...
            <script>
                ...
                if((selected_cndctv_rstvty_optn > 0) && (selected_freq_range_optn > 0)) {
                  ...
                  if(cndctv_rstvty_optn ==='conductivity') {
                      ...
                      if (condctvty_val > 0 && error_flag === 'OFF') {
                          document.getElementById('skin_dpth_result_sctn').style.display = "block";
              ...
              function compute_sar(){
                  ...
                  if (error_flag === 'OFF') {
                      document.getElementById('sar_basic_result_sctn').style.display = "block";
                            //displays result section
              ...
              function compute_fspl(){
                  ...
                  if ((selected_fspl_dist_range_optn > 0) && (selected_fspl_freq_range_optn > 0)) {
                      ...
                      if (error_flag === 'OFF') {
                          document.getElementById('fspl_result_sctn').style.display = "block";
                                //displays result section
              ...
              function head_model_compute() {
                  ...
                  if (selected_head_siz_model_option > 0) {
                      ...
                      if (head_siz_val > 0) {
                          ...
                          if (error_flag === 'OFF') {
                              document.getElementById('tissue_thickness_result_sctn').style.display = "block";
                                    //displays result section
              ...
              function sar_advanced_compute(){
                  ...
                  var brain_sz_pcntg = 90.00;
                    ...
                    if ((selected_head_siz_model_option > 0) &&
                        ...
                        if (error_flag === 'OFF') {
                            document.getElementById('sar_advncd_result_sctn').style.display = "block";
                                  //displays result section
                    ...
                    function compute_advanced_sar(tsse_condvty_val, tsse_dnsty_val){
                      ...
                      // =======================SAR ADVANCED========================
              function dielectric_properties_fetch(){
                dev_notification();
              }
                      // ====================DIELECTRIC PROPERTIES===================
              function dev_notification(){
                alert("Sorry!\n -This section is currently under development.");
                //notication fn info
              }
            // ------------reseting action-------------
            function dielectric_properties_reset(){
              dev_notification();
            }
              function skin_dpth_fields_reset(){
                 var reset_action = confirm("Confirm reset action!");
                 if (reset_action == true) {
                    document.getElementById('skin_dpth_result_sctn').style.display = "none";
                        //hides result section on fields reset
              ...
              function fspl_fields_reset(){
                 var reset_action = confirm("Confirm reset action!");
                 if (reset_action == true) {
                    document.getElementById('fspl_result_sctn').style.display = "none";
                        //hides result section on fields reset
              ...
              function sar_fields_reset(){
                 var reset_action = confirm("Confirm reset action!");
                 if (reset_action == true) {
                    document.getElementById('sar_basic_result_sctn').style.display = "none";
                        //hides result section on fields reset
              ...
              function head_model_fields_reset(){
                 var reset_action = confirm("Confirm reset action!");
                 if (reset_action == true) {
                    document.getElementById('tissue_thickness_result_sctn').style.display = "none";
                        //hides result section on fields reset
              ...
              function sar_advanced_fields_reset(){
                 var reset_action = confirm("Confirm reset action!");
                 if (reset_action == true) {
                    document.getElementById('sar_advncd_result_sctn').style.display = "none";
                        //hides result section on fields reset
