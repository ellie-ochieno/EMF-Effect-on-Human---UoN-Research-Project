...
?>
        ...
        font-weight: bold !important;
                ...
                <div class="content-tools">
                  <div class="property_dfn_sctn">
                    ...
                    also a handy button labelled <span class="special-terms">Details</span> which when clicked, invokes a small pop-up window with quite detailed information about the computed SAR analysis.
                   <div class="img-section">
                   ...
                   <div class="img-section">
                     <img class="img-formula" src="static/imgs/SAR_calc_guide/SAR_computation_details.png"><br>
                    ...
                    <div class="calc-tool-section">
                      ...
                      <form class="calc-tool-section" id="src_distance_form1">
                          ...
                          <div class="age_sctn" id="hd_size_sctn">
                            ...
                            <input type="text" name="ageset_hd_size_val" id="ageset_hd_size_val" value="" placeholder="" readonly>&nbsp;[<span class="special-term">cm</span>]
                            <br>
                            <div class="sections-seperator">
                              <hr>
                            </div><br>
                      ...
                      <form class="calc-tool-section" id="sar_result_form">
                          <br>
                          <label class="rf-lalbels"><span class="special-terms"  style="color: #537895">5.</span>SAR Result</label><br>
                          <input type="text" name="sar_result_val" id="sar_result_val" value="" placeholder="" readonly>&nbsp;[<span class="special-term">W/Kg</span>]
                          <br><br>
                          <button type="button" class="btn sar_simplified_reset-btn" onclick="reset_properties_dfn_sctn();" name="reset_properties_sctn_button" title="clear & refresh section">Clear</button>
                          <button type="button" class="btn calculate-btn nxt-btn details-btn" onclick="compttn_details();" name="computation_properties_sctn_button" title="More SAR details">Details</button><br><br>
                          <div class="sections-seperator">
                            <hr>
                              <span class="dot"></span>
                              <span class="dot"></span>
    ...
    <script>
       ...
       function technology_fns_selector(){
         ...
         if(technology_type_optn==="gsm1") {
           ...
           if(rf_source_optn==="gsm_module" || rf_source_optn==="others") {
             ...
             error_flag = "ON";
             definiteFormsExclusion();
             //suppress proceeding sections display
           }
         }
      ...
      function compttn_details(){
        ...
        alert("Computation Summary\n--------------------------------\n\n1. TECHNOLOGY - "+ technology +"\n2. RF-SOURCE - "+ rf_src +"\n3. TISSUE - "+ tissue_type +"\n\n-Impedance: "+ tissue_impdnc.toFixed(4)+" [Ω]\n-Skin depth: "+ skin_dpth.toFixed(4)+" [m]\n-Power density: "+ pwr_dnsty.toFixed(4)+" [W/m^3]\n-E-field: "+ e_field.toFixed(4)+" [V/m]\n-SAR: "+ sar_val.toFixed(6)+" [W/Kg]");
      }
      ...
      function definiteFormsExclusion(){
        document.getElementById("age_en_hd_size_sctn").style.display = "none";
        document.getElementById("src_distance_form1").style.display = "none";
        document.getElementById("sar_result_form").style.display = "none";
      }  //hide forms definitely
    </script>
    <script>
